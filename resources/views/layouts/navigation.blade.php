            ...
            <div class="pt-4 pb-2 px-2 border-t border-gray-200">
                <div class="flex items-center mb-3">
                    <div class="flex-shrink-0">
                        <img class="w-10 h-10 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}" alt="{{ Auth::user()->name }}">
                    </div>
                    <div class="ml-3">
            ...
            <ul class="space-y-1 font-medium border-t border-gray-200 pt-4">
                ...
                <li>
                    <x-nav-link :href="route('reportcard.upload')" :active="request()->routeIs('reportcard.upload')">
                        ...
                        <span class="ms-3 font-medium">{{ __('Halaman Import') }}</span>
                    </x-nav-link>
                </li>
                ...
                <li>
                    <x-nav-link :href="route('classes.create')" :active="request()->routeIs('classes.create')">
                        ...
                        <span class="ms-3 font-medium">{{ __('Tambah Kelas') }}</span>
                    </x-nav-link>
                </li>
                <li>
                    <x-nav-link :href="route('semesters.create')" :active="request()->routeIs('semesters.create')">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm14-7.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1Zm0 4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1Zm-5-4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1Zm0 4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1Zm-5-4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1Zm0 4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1Z"/>
                            <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4Z"/>
                        </svg>
                        <span class="ms-3 font-medium">{{ __('Tambah Semester') }}</span>
                    </x-nav-link>
                </li>
            </ul>
            ...
            <div class="pt-4 mt-4 space-y-2 border-t border-gray-200">
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-nav-link :href="route('logout')" 
                        ...
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="none" viewBox="0 0 18 16">
